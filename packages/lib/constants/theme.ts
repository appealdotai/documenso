...
export const DEFAULT_BRAND_COLORS = {
  ...
  // Filled defaults match the previous hard-coded white fill + required/optional borders.
  fieldRequiredFilledCard: '#ffffffe6', //  0 0% 100% / 0.9
  fieldRequiredFilledCardBorder: '#a2e771', // 95.08 71.08% 67.45%
  fieldRequiredFilledCardBorderHover: '#7db83a', // darker green
  ...
  fieldOptionalFilledCard: '#ffffffe6', //  0 0% 100% / 0.9
  fieldOptionalFilledCardBorder: '#e2e8f0', // 214.3 31.8% 91.4%
  fieldOptionalFilledCardBorderHover: '#94a3b8', // slate-400
...
export const DEFAULT_BRAND_LENGTHS = {
  ...
  fieldRequiredFilledCardBorderWidth: '2px',
  fieldOptionalCardBorderWidth: '2px',
  fieldOptionalFilledCardBorderWidth: '2px',
