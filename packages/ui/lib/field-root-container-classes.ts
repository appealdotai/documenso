const FIELD_ROOT_CONTAINER_SHARED_CLASS_NAME =
  'field--FieldRootContainer field-card-container dark-mode-disabled group rounded-[2px] transition-all';
 ...
 */
export const FIELD_PROBE_ANCHOR_SELECTOR = '.embed--DocumentContainer, .documenso-branded';
